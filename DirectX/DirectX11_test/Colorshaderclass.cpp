...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	std::string vs_filename = "color.vs.hlsl";
	std::string ps_filename = "color.ps.hlsl";
	std::string vs_path = DATA_FOLDER + vs_filename;
	std::string ps_path = DATA_FOLDER + ps_filename;

	std::wstring_convert<std::codecvt_utf8_utf16<wchar_t>> converter;
	std::wstring vs_path_w = converter.from_bytes(vs_path);
